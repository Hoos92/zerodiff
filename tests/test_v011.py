...
def test_record_class_and_replay_dataclass_methods(ws):
    (ws / "v11shop.py").write_text(textwrap.dedent(CLASS_MODULE),
                                   encoding="utf-8")
    importlib.invalidate_caches()
    assert zerodiff.record_class("v11shop", "Cart") == 2
